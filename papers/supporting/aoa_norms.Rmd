---
title: "\\LARGE{Estimating ages of acquisition for animal words}"
...
```{r animalgame-data, include = F}
word_difficulty <- read_feather(here("data/word_difficulty.feather")) %>%
  left_join(predicted_aoas, by = c("word"))

animalgame_cor <- cor.test(word_difficulty$difficulty, word_difficulty$aoa)
```
