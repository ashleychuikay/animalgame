...
```{r difficulty-fig, fig.width = 4, fig.height = 3, fig.cap = "Proportion of parents who reported that their child understood the word for each of our target animals. Error bars indicate 95\\% confidence intervals computed by non-parametric bootstrap. Colors indicate apriori categorization of words into early and late Age of Acquisition"}
