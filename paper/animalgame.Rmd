...
author-information: > 
    \author{{\large \bf Ashley Leung} \\ \texttt{author1@university.edu} \\ Department of Psychology \\ University of Chicago
    \{\large \bf Alexandra Tunkel} \\ \texttt{author1@university.edu} \\ Department of Psychology \\ University of Chicago
    \And {\large \bf Daniel Yurovsky} \\ \texttt{author1@university.edu} \\ Department of Psychology \\ University of Chicago}
...
keywords:
  parent-child interaction; language development
...
Language, at its core, is communicative. People use language daily to interact with others, and even children as young as six months understand the communicative nature of spoken language (Vouloumanos, Martin, & Onishi, 2014). For young children, communication with others also plays a crucial role in language acquisition. Most of young children's language input come from parents, and while statistical learning likely plays a part in language acquisition (e.g. Saffran, 2003), successful learning may also rely on parents' sensitivity to their children's knowledge, interests, and developmental level (Hoff-Ginsberg & Shatz, 1982; Tamis-LeMonda, Kuchirko, & Song, 2014; Yurovsky, Doyle, & Frank, 2016). Focusing on parent and child as a dyad, rather than isolated individuals, is important when seeking to understand the ways in which parental input influences children's language acquisition.
